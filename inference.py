...
from utils.my_convert_csqa import convert_to_entailment
from utils.my_grounding import ground
from utils.my_graph import generate_adj_data_from_grounded_concepts__use_LM
from utils.my_graph import generate_adj_data_from_grounded_concepts__use_LM_api
from modeling.my_modeling_qagnn import *
from utils.parser_utils import *

from utils.my_data_utils import *
...
def main():
    ...
    mytest_data= {"id": "000990552527b1353f98f1e1a7dfc643", "question": {"question_concept": "star", "choices": [{"label": "A", "text": "hollywood"}, {"label": "B", "text": "skyline"}, {"label": "C", "text": "outer space"}, {"label": "D", "text": "constellation"}, {"label": "E", "text": "solar system"}], "stem": "There is a star at the center of what group of celestial bodies?"}}
    ...
    ##get the grounded
    test_grounded = ground(test_statment,cpnet_vocab_path='./data/cpnet/concept.txt',pattern_path='./data/cpnet/matcher_patterns.json' ,num_processes=6)
    #
